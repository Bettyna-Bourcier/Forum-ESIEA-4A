...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2>
                Bienvenue sur votre espace personnel <?php echo $_SESSION['identifiant']; ?>.
                <?php
                if (is_actif($_SESSION['identifiant'])) {
                    echo '<small>Votre compte est validé.</small>';
                } else {
                    echo '<small>Votre inscription au forum doit être valider par les administrateurs.</small>';
                }
                ?>
            </h2>
